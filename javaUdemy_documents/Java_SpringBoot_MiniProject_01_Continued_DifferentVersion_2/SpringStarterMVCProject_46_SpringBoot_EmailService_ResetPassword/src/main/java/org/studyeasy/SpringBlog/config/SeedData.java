...
public class SeedData implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
       ...
       account03.setAge(55);
       account03.setDate_of_birth(LocalDate.parse("1998-02-01"));
       ...
       account04.setAge(40);
       account04.setDate_of_birth(LocalDate.parse("1973-08-01"));
       account04.setGender("Male");

       //Extra Added from me
       account05.setEmail("testemailmj2024@gmail.com");
       account05.setPassword("testemail2024_$");
       account05.setFirstname("Test");
       account05.setLastname("Demo Email send");
       account05.setRole(Roles.ADMIN.getRole());
       account05.setAge(40);
       account05.setDate_of_birth(LocalDate.parse("1973-08-01"));
